...
from debate_kg.consensus.check import is_consensus
from debate_kg.data.fever import load_claims
from debate_kg.debate.orchestrator import run_debate, run_single_expert
from debate_kg.eval.metrics import convergence_rate, kg_drift, label_accuracy, macro_f1
from debate_kg.eval.verdict import classify_verdict
from debate_kg.judges.panel import build_judge_panel
from debate_kg.kg.construct import build_kg_pair
from debate_kg.kg.graph import KnowledgeGraph
from debate_kg.kg.schema import DebateEdge, DebateNode, ExpertScore, JudgeScore  # ExpertScore used by MergerFn
from debate_kg.merger.baselines import naive_union_merge, random_merge
from debate_kg.merger.rule_based import merge_kgs
from debate_kg.retriever.retriever import retrieve
