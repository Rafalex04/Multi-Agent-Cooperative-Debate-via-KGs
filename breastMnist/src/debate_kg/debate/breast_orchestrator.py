...
from breastMnist.src.debate_kg.kg.schema import (
    DebateAddress,
    DebateEdge,
    DebateNode,
    SingleAgentResult,
...
def _make_expert_client(cfg: DictConfig) -> LLMClient:
    ...
    num_ctx: int = int(getattr(cfg.model, "num_ctx", 32768))
    return OllamaClient(model=cfg.model.expert_model, base_url=base_url, num_ctx=num_ctx)
